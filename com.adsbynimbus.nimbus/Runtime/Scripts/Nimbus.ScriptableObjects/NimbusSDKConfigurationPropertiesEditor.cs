...
namespace Nimbus.ScriptableObjects {
	...
	public class NimbusSDKConfigurationPropertiesEditor : Editor {
		...
		// AdMob
		private SerializedProperty _adMobAutoInit;
		...
		private void OnEnable() {
			...
			// IOS AdMob UI
			_adMobAutoInit = serializedObject.FindProperty("adMobAutoInit");
		...
		public override void OnInspectorGUI() {
			...
			EditorDrawUtility.DrawEditorLayoutHorizontalLine(Color.gray, 5);
				...
				EditorGUILayout.LabelField("AdMob Configuration", headerStyle);
					...
					EditorGUILayout.LabelField("Auto Initialization", headerStyle);
					EditorGUILayout.PropertyField(_adMobAutoInit);
					GUILayout.Space(10);
