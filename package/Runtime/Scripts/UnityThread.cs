...
namespace Nimbus.Runtime.Scripts {
	...
	public class UnityThread : MonoBehaviour {
		...
		private List<Action> _actionCopiedQueueFixedUpdateFunc = new List<Action>();
		...
		public void Update() {
			...
			foreach (var t in _actionCopiedQueueUpdateFunc) t.Invoke();
		}
#endif
		...
		public void LateUpdate() {
			...
			foreach (var t in _actionCopiedQueueLateUpdateFunc) t.Invoke();
		}
#endif
		...
		public void FixedUpdate() {
			...
			foreach (var t in _actionCopiedQueueFixedUpdateFunc) t.Invoke();
		}
#endif
	}
}